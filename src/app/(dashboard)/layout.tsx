  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <aside 
          className={cn(
            "fixed inset-y-0 left-0 z-50 w-64 bg-white border-r transform transition-transform duration-200 lg:translate-x-0 lg:static lg:z-auto overflow-y-auto",
        ...
        >
          <div className="flex flex-col h-full">
            ...
            <div className="p-4 border-t sticky bottom-0 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60">
